...
// page, so it stays here in gallery rather than in @geist-nuxt/core.
//
...
const LG_PX = 1024 // enable the split from the lg breakpoint up
...
onMounted(() => {
  mql = window.matchMedia(`(min-width: ${LG_PX}px)`)
