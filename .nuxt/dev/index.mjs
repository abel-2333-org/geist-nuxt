...
import { snakeCase } from 'file:///vercel/share/v0-project/node_modules/.pnpm/scule@1.3.0/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///vercel/share/v0-project/node_modules/.pnpm/unctx@2.5.0/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///vercel/share/v0-project/node_modules/.pnpm/radix3@1.1.2/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///vercel/share/v0-project/node_modules/.pnpm/consola@3.4.2/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///vercel/share/v0-project/node_modules/.pnpm/youch-core@0.3.3/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///vercel/share/v0-project/node_modules/.pnpm/youch@4.1.1/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///vercel/share/v0-project/node_modules/.pnpm/source-map@0.7.6/node_modules/source-map/source-map.js';
...
const _0WJ0tx4s6ciXXrhER9f4gZo1yqu5HZOVgshki1uunpI = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
