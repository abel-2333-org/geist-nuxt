...
// values and are the canonical contract shared by EnumTable (which
...
// land flat in `app/components/`. A cross-directory relative import from a util
// to a component would not resolve identically across those two topologies;
// auto-imported utils do. EnumTable.vue re-exports these for
...
/** Public props contract for EnumTable. Kept outside the SFC so its
