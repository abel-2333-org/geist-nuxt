...
> 活的间距展示见 `ShowcaseFoundations.vue` 的 spacing scale。
...
- 间距/圆角展示：`packages/core/app/components/showcase/ShowcaseFoundations.vue`
- 节奏用法：`packages/core/app/components/showcase/ShowcaseHero.vue`、`ShowcaseComponents.vue`
