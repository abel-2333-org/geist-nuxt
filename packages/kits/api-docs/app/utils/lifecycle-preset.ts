...
// `BadgeTone` is provided by @geist-nuxt/core and auto-imported across the layer
// (core exposes it from app/utils/badge.ts). No explicit import needed.
 ...
 * from the core atom so the atom stays reusable and this calibration is easy to
